...
import { createAlexaMiddleware } from './alexaBridge.mjs';
...
const alexa = createAlexaMiddleware();
...
const server = createServer(async (req, res) => {
  await bridge(req, res, async () => alexa(req, res, async () => calendar(req, res, async () => {
